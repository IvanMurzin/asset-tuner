...
part 'subaccount_dto.freezed.dart';
part 'subaccount_dto.g.dart';

@Freezed(fromJson: true, toJson: true)
abstract class SubaccountDto with _$SubaccountDto {
  const factory SubaccountDto({
    required String id,
    ...
    @JsonName('current_amount_atomic') @NullableDecimalJsonConverter() Decimal? currentAmountAtomic,
  ...
  factory SubaccountDto.fromJson(Map<String, dynamic> json) {
    return _$SubaccountDtoFromJson(json);
  }
}
