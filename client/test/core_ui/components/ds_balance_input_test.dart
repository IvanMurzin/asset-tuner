...
void main() {
  testWidgets('is enabled by default and renders currency badge', (tester) async {
    await tester.pumpWidget(_TestApp(child: const DSBalanceInput(currencyBadge: Text('USD'))));
  ...
  testWidgets('respects disabled state', (tester) async {
    await tester.pumpWidget(
      _TestApp(child: const DSBalanceInput(enabled: false, currencyBadge: Text('EUR'))),
    );
  ...
  testWidgets('shows amount and currency errors inline', (tester) async {
    await tester.pumpWidget(
      _TestApp(
        child: const DSBalanceInput(
          amountErrorText: 'Enter amount',
          currencyErrorText: 'Select currency',
          currencyBadge: Text('Currency'),
        ),
      ),
    );
