# Asset Tuner — Non-goals

**Last updated:** 2026-02-10

## Not in MVP
- Expense tracking (transactions, categories, budgets).
- Income tracking and cashflow statements.
- Bank syncing / automated imports / open banking connections.
...
## Explicitly “later”
- Analytics as a paid feature (after MVP release).
- “Hide amounts” mode (blur totals until revealed).
- Extra premium features: more currencies, more accounts, AI insights.
