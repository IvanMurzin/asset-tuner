# Asset Tuner docs (MVP v2 rewrite)

This `docs/` folder is the single source of truth for the rewrite.
...
If the client, migrations, or Edge Functions disagree with contracts, treat it as a bug.
