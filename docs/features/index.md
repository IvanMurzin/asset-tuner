...
| FTR-005 | [Subaccounts inside accounts (unlimited)](FTR-005-assets-in-accounts.md) | P0 | FTR-001, FTR-004 |
| FTR-006 | [Balance entries (snapshot-only) with history](FTR-006-balance-entries-snapshot-and-delta.md) | P0 | FTR-005 |
| FTR-007 | [Server-cached rates (hourly) and rates timestamp](FTR-007-rates-sync-and-rates-read.md) | P0 | — |
| FTR-008 | [Main totals, breakdown, drill-down](FTR-008-overview-totals-and-drilldown.md) | P0 | FTR-003, FTR-006, FTR-007 |
| FTR-010 | [Analytics: breakdown + updates feed](FTR-010-analytics-breakdown-and-updates.md) | P0 | FTR-003, FTR-006, FTR-007, FTR-008 |
